...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__service_index__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_index__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__form_index__ = __webpack_require__(7);
...
class App {
    ...
    constructor ({el}) {
        ...
        this.menu = new __WEBPACK_IMPORTED_MODULE_1__menu_index__["a" /* Menu */]({
            el: el.querySelector('.js-menu'),
            data: {}
        });

        this.form = new __WEBPACK_IMPORTED_MODULE_2__form_index__["a" /* Form */]({
     ...
     */
    loadData() {
        __WEBPACK_IMPORTED_MODULE_0__service_index__["a" /* Service */].getItems()
     ...
     */
    uploadData() {
        __WEBPACK_IMPORTED_MODULE_0__service_index__["a" /* Service */].putItems(this.menu.data)
